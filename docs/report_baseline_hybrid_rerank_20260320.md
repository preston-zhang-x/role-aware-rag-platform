...
| 18 | documents.updated_at の自動/更新は何で... | admin | admin | HIT | 5 | - | - |
...
- **実際の回答**: 仕様書のタイトルは「Role Aware RAG Platform」です。（出典: 参考1）
...
---
*Generated by `script/run_eval.py` at 2026-03-20 00:48:20*