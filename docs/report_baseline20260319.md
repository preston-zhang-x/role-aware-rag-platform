...
| 4 | FN-010 のカテゴリは何ですか？ | admin | admin | MISS | 5 | keyword_mismatch | - |
...
- **不足キーワード**: Parser
- **先頭 Source**: docs/role_aware_rag_platform_spec.xlsx
- **実際の回答**: FN-010 のカテゴリは「Health」です。（出典: 参考4）
...
- **先頭 Source**: docs/role_aware_rag_platform_spec.xlsx
- **実際の回答**: ITM-SCR003-002は、RAG問合せ画面において現在ログイン中ユーザーのroleを表示します。出典は【参考2】です。
...
---
*Generated by `script/run_eval.py` at 2026-03-19 00:41:51*